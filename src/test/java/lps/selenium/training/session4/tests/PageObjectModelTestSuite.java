...
import lps.selenium.training.session4.pageobjectmodel.pages.HomePage;
import lps.selenium.training.session4.pageobjectmodel.pages.LoginPage;

public class PageObjectModelTestSuite {
